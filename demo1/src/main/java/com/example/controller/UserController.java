...
//    }
//@RequestParam("currentPage1")
    @GetMapping("/page1")
    public Result selectpage1( int currentPage, @RequestParam("pageSize1") int pageSize, @RequestParam("keyword") String keyword, @RequestParam("phone") String phone) {
